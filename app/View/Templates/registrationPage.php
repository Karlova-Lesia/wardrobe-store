    ...
    <div class="col-md-5">
        ...
        <form class="form"  method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="lastname" class="form-control" id="exampleInputPassword1" value="<?php echo $lastname?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="password" name="password_confirm" class="form-control" id="exampleInputPassword1" value="<?php echo $passwordConfirm?>">
            </div>
            <div>
                <button name="submit" type="submit" class="btn btn-outline-secondary">Зареєструватись</button>
            </div>
            <a class="link" href="/authorization">вже зареєстровані?</a>
        </form>
    </div>
</div>
<?php
